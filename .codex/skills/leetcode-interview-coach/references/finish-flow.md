...
- Optional workflow metadata JSON for Chinese long text (`problemTitle`, `thinking`, `solutionJava`, `noteContent`, `statementMarkdown`, `processMarkdown`, `complexityMarkdown`, `pitfalls`).
